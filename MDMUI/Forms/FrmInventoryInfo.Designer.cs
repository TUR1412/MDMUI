...
namespace MDMUI
{
    partial class FrmInventoryInfo // Make partial
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.placeholderLabel.Text = "库存信息管理功能正在开发中，敬请期待..."; // Specific text
            // 
            // titleLabel
            // 
            ...
            this.titleLabel.Text = "库存信息管理"; // Specific text
            // 
            // FrmInventoryInfo
            // 
            ...
            this.Name = "FrmInventoryInfo";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "库存信息";
            this.Load += new System.EventHandler(this.FrmInventoryInfo_Load);
